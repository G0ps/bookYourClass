        ...
        {users?.map((user) => (
          <div key={user._id} className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <span className={`${styles.roleBadge} ${styles[user.typeOfUser] || ""}`}>
                {user.typeOfUser}
              </span>
            </div>
            ...
            <div className={styles.cardBody}>
              ...
              <div className={styles.infoLine}>
                ...
                <span className={styles.val}>{user.contactNumber || "—"}</span>
              </div>
              <div className={styles.infoLine}>
                <span className={styles.label}>System ID:</span>
                <span className={styles.uid}>{user._id}</span>
              </div>
            </div>
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.modalCard}>
            <h2 className={styles.modalTitle}>
              {editingUser ? "Modify User Account" : "Register Campus User"}
            </h2>

            <form
              onSubmit={editingUser ? handlePatchUser : handleCreateUser}
